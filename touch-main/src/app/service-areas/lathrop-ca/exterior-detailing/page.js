...
const sections = [
  {
    ...
    title: "Comprehensive Exterior Detailing Services in Lathrop, CA",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Give your vehicle the attention it deserves with our professional exterior detailing services in Lathrop, California. 
        ...
        <div style={{ marginBottom: "1rem" }}>
          Why Choose Our Exterior Detailing in Lathrop?
        </div>
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-blue-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Exterior Detailing Services in Lathrop, CA
          </h1>
