...
const sections = [
  {
    ...
    title: "Professional Interior Detailing Services in Lathrop, CA",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Experience the ultimate interior transformation with our professional interior detailing services in Lathrop, California. 
          Touch & Shine Auto Detail specializes in deep cleaning and sanitizing your vehicle's interior, removing stains, 
          odors, and restoring that fresh, new-car feeling. Our mobile service brings professional equipment to your doorstep.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Why Choose Our Interior Detailing in Lathrop?
        </div>
        ...
        <ul className="list-none text-gray-300 mt-4 space-y-2">
          <li className="flex items-center gap-2">
            ...
            Deep cleaning of all interior surfaces and components
          </li>
          <li className="flex items-center gap-2">
            <FaArrowRight className="text-[#2A82AD]" />
          ...
          <li className="flex items-center gap-2">
            <FaArrowRight className="text-[#2A82AD]" />
            Odor elimination and sanitization services
          </li>
          <li className="flex items-center gap-2">
            <FaArrowRight className="text-[#2A82AD]" />
        ...
        <div style={{ marginTop: "1rem" }}>
          Transform your vehicle's interior with our comprehensive detailing service.
        </div>
      </div>
    ),
    imgSrc: "/images/interior-detailing-1009x1024-1.jpg",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-blue-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Interior Detailing Services in Lathrop, CA
          </h1>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-black via-black to-[#2A82AD] pt-16 pb-32 space-y-24">
        ...
        <div className="lg:mx-auto lg:max-w-7xl lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive interior cleaning and restoration for your vehicle
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Deep cleaning of dashboard, center console, and instrument panel',
                icon: '📱'
              },
              {
                title: 'Seats & Upholstery',
                description: 'Stain removal and fabric restoration for all seating surfaces',
                icon: '🪑'
              },
              {
                title: 'Carpet & Flooring',
                description: 'Deep carpet cleaning and floor mat restoration',
                icon: '🧹'
              },
              {
                title: 'Windows & Mirrors',
                streak: 'Streak-free cleaning of all glass surfaces',
                icon: '🪟'
              },
              {
                title: 'Door Panels',
                description: 'Cleaning and conditioning of door panels and handles',
                icon: '🚪'
              },
              {
                title: 'Air Vents',
                description: 'Cleaning and sanitizing of air conditioning vents',
                icon: '💨'
              }
            ].map((service, index) => (
        ...
        <div className="lg:mx-auto lg:max-w-7xl lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Why regular interior detailing is essential for your vehicle
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Remove allergens, bacteria, and germs for a healthier driving environment',
                icon: '🏥'
              },
              {
                title: 'Odor Elimination',
                description: 'Eliminate unpleasant odors and restore fresh, clean air',
                icon: '🌸'
              },
              {
                title: 'Value Preservation',
                description: 'Maintain your vehicle\'s resale value with regular interior care',
                icon: '💰'
              },
              {
                title: 'Comfort Enhancement',
                description: 'Enjoy a more comfortable and pleasant driving experience',
                icon: '😌'
              }
            ].map((benefit, index) => (
