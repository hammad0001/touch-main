...
const sections = [
  {
    ...
    title: "Premium Ceramic Coating Services in Manteca, CA",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Protect your investment with our professional ceramic coating services in Manteca, California. Touch & Shine Auto Detail 
          is your trusted <Link href="/" className="text-[#2A82AD] font-semibold">mobile car detailing</Link> specialist with 
          over ten years of experience. Our ceramic coating service provides long-lasting protection that shields your vehicle 
          from environmental damage while maintaining a brilliant shine for years to come.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Why Choose Our Ceramic Coating in Manteca?
        </div>
        ...
        <ul className="list-none text-gray-300 mt-4 space-y-2">
          <li className="flex items-center gap-2">
            ...
            Advanced ceramic technology for maximum protection
          </li>
          <li className="flex items-center gap-2">
            <FaArrowRight className="text-[#2A82AD]" />
            Professional application by certified technicians
          </li>
          <li className="flex items-center gap-2">
            <FaArrowRight className="text-[#2A82AD]" />
            Long-lasting results that protect against UV rays and contaminants
          </li>
          <li className="flex items-center gap-2">
            <FaArrowRight className="text-[#2A82AD]" />
        ...
        <div style={{ marginTop: "1rem" }}>
          Protect your investment with our premium ceramic coating service in Manteca, CA.
        </div>
      </div>
    ),
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-blue-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Ceramic Coating Services in Manteca, CA
          </h1>
        ...
        <div className="lg:mx-auto lg:max-w-7xl lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover why ceramic coating is the ultimate protection for your vehicle
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: 'UV Protection',
                description: 'Shields your paint from harmful UV rays that cause fading and oxidation',
                icon: '☀️'
              },
              {
                title: 'Chemical Resistance',
                description: 'Protects against bird droppings, tree sap, and other contaminants',
                icon: '🛡️'
              },
              {
                title: 'Hydrophobic Effect',
                description: 'Water beads up and rolls off, making cleaning easier',
                icon: '💧'
              },
              {
                title: 'Long-Lasting Shine',
                description: 'Maintains showroom-quality appearance for years',
                icon: '✨'
              },
              {
                title: 'Scratch Resistance',
                description: 'Provides additional protection against minor scratches',
                icon: '🔒'
              },
              {
                title: 'Cost Effective',
                description: 'Reduces the need for frequent waxing and detailing',
                icon: '💰'
              }
            ].map((benefit, index) => (
