...
const sections = [
  {
    ...
    title: "Expert Paint Correction Services in Manteca, CA",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Transform your vehicle's appearance with our professional paint correction services in Manteca, California. 
        ...
        <div style={{ marginBottom: "1rem" }}>
          Why Choose Our Paint Correction in Manteca?
        </div>
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-blue-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Paint Correction Services in Manteca, CA
          </h1>
